...
do fastqc ${f}_L007_R1_001_paired.fq.gz --outdir=../data/reports/trimmed/R1_paired;
fastqc ${f}_L007_R2_001_paired.fq.gz --outdir=../data/reports/trimmed/R1_paired;
fastqc ${f}_L007_R1_001_unpaired.fq.gz --outdir=../data/reports/trimmed/R1_unpaired;
fastqc ${f}_L007_R2_001_unpaired.fq.gz --outdir=../data/reports/trimmed/R2_unpaired;
done
