...
do echo "prodigal -a ../data/prediction/${f}.faa -d ../data/prediction/${f}.ffn -i ../data/assembly/${f}_contigs.fasta -o ../data/prediction/${f}.gbk -p meta -s ../data/prediction/${f}_genes.gff";
done
