...
do spades.py --rna --12 ../data/filter/nonhost/${f}_p_filtered.fastq --s1 ../data/filter/nonhost/${f}_R1_filtered.fastq --s2 ../data/filter/nonhost/${f}_R2_filtered.fastq -t 4 -k 21,33,55,77,99,111,127 -o ../data/reports/assembly/${f}_assembly
done
